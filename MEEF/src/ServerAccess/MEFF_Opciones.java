...
public class MEFF_Opciones {
    ...
    public ArrayList<Opcion> OpcionesCALL = new ArrayList<>();
    public ArrayList<Opcion> OpcionesPUT = new ArrayList<>();
    ...
    public boolean divideOptions(){
        if(getOptions()){
            for (Opcion opt : Opciones) {
                if(opt.Tipo.equals("CALL"))
                    OpcionesCALL.add(opt);
                else
                    OpcionesPUT.add(opt);
            }
            return true;
